...
const navbar = () => (
    <nav>
        <Grid container direction="row" className="container" justify="space-between"  alignItems="center">
            <Grid item >
                <ul>
                    <li id="onSale"><img src={priceTag} alt="price tag" /><span>محصولات شگفت انگیز</span></li>
                    <li><span>خانه</span></li>
                    <li><span>پوشاک</span></li>
                    <li><span>کودک و اسباب بازی</span></li>
                    <li><span>مراقبت از کودک</span></li>
                </ul>
            </Grid>
            <Grid item>
                <ul>
